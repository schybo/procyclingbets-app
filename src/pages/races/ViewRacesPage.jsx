            ...
            {races.map((r) => {
              ...
              return (
                <IonCard
                  color="light"
                  key={`race-${r?.id}`}
                  className="w-full md:w-64 h-64 py-4 mx-6 flex flex-row items-center text-ellipsis bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
                >
