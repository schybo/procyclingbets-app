// Run with node --experimental-modules supabase/functions/scrape/pcs/timeTrial.mjs belgium 2023

import { gotScraping } from "got-scraping";
import * as cheerio from "cheerio";

const args = process.argv;
const country = args[2] || "belgium";
const year = args[3] || "2023";

console.log(country);
console.log(year);

const response = await gotScraping.get(
  `https://www.procyclingstats.com/race/nc-${country}-itt/${year}/result`
);
